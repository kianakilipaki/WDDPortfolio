...
export default class Hikes {
  constructor(elementId) {
    ...
    this.comments = new Comments("hikes", document.getElementById("comments"));
  }
  // if location of hikeList ever moves I can change it here
  getAllHikes() {
    console.log();
    return hikeList;
  }
  ...
  showOneHike(hikeName) {
    ...
    this.comments.showHikeComments(hikeName);
  }
